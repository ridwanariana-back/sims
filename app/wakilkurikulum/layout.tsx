...
export default function wakilKurikulumLayout({
  children,
}: {
    ...
    <div className="flex h-screen bg-gray-100 text-slate-900 overflow-hidden relative">
      ...
      `}>
        ...
        <nav className="flex-1 overflow-y-auto pt-4 pb-8 px-4 space-y-2 [scrollbar-width:thin] [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-slate-800 [&::-webkit-scrollbar-thumb]:rounded-full">
          <Link href="/wakilkurikulum" className={getLinkStyle('/wakilkurikulum')} onClick={() => setIsOpen(false)}>
            Dashboard
          </Link>
          <Link href="/wakilkurikulum/dataguru" className={getLinkStyle('/wakilkurikulum/dataguru')} onClick={() => setIsOpen(false)}>
            Data Guru
          </Link>
          <Link href="/wakilkurikulum/datamurid" className={getLinkStyle('/wakilkurikulum/datamurid')} onClick={() => setIsOpen(false)}>
            Data Murid
          </Link>
          <Link href="/wakilkurikulum/rekap-nilai" className={getLinkStyle('/wakilkurikulum/rekap-nilai')} onClick={() => setIsOpen(false)}>
            Rekap Nilai Murid
          </Link>
          <Link href="/wakilkurikulum/monitoring-jadwal" className={getLinkStyle('/wakilkurikulum/monitoring-jadwal')} onClick={() => setIsOpen(false)}>
            Jadwal Pelajaran
          </Link>
          <Link href="/wakilkurikulum/kehadiran" className={getLinkStyle('/wakilkurikulum/kehadiran')} onClick={() => setIsOpen(false)}>
            Kehadiran
          </Link>
          ...
          <Link href="/wakilkurikulum/inputnilai" className={getLinkStyle('/wakilkurikulum/inputnilai')} onClick={() => setIsOpen(false)}>
            Input Nilai
          </Link>
          <Link href="/wakilkurikulum/riwayat-nilai" className={getLinkStyle('/wakilkurikulum/riwayat-nilai')} onClick={() => setIsOpen(false)}>
            Riwayat Nilai
          </Link>
        </nav>
      </aside>
