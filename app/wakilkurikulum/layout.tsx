    ...
    <div className="flex min-h-screen bg-gray-100 text-slate-900 relative">
      ...
      `}>
        ...
        <nav className="mt-6 space-y-2 px-4">
          <Link href="/wakilkurikulum" className={getLinkStyle('/wakilkurikulum')}>
            Dashboard
          </Link>
          ...
          <Link href="/wakilkurikulum/jadwal" className={getLinkStyle('/wakilkurikulum/jadwal')}>
            Jadwal Pelajaran
          </Link>
      ...
      <Link href="/wakilkurikulum/inputnilai" className={getLinkStyle('/wakilkurikulum/inputnilai')}>Input Nilai</Link>
      <Link href="/wakilkurikulum/riwayat-nilai" className={getLinkStyle('/wakilkurikulum/riwayat-nilai')}>Riwayat Nilai</Link>
        </nav>
      </aside>
