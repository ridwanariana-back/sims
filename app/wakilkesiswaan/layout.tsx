...
export default function KepalaSekolahLayout({
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 text-slate-900 relative">
      ...
      <Link href="/wakilkesiswaan/inputnilai" className={getLinkStyle('/wakilkesiswaan/inputnilai')}>Input Nilai</Link>
      <Link href="/wakilkesiswaan/riwayat-nilai" className={getLinkStyle('/wakilkesiswaan/riwayat-nilai')}>Riwayat Nilai</Link>
        </nav>
      </aside>
